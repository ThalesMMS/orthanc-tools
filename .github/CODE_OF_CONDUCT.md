...
For general moderation concerns, open a GitHub issue if the discussion can be
public and non-sensitive. For sensitive concerns, use GitHub's private
maintainer contact or moderation channels available in the repository.
