...
WAIT_SECONDS="${ORTHANC_START_WAIT_SECONDS:-60}"
QUIET_WAIT_SECONDS="${ORTHANC_START_QUIET_WAIT_SECONDS:-10}"
...
echo "Orthanc did not become ready after ${WAIT_SECONDS}s." >&2
